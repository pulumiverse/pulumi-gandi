...
namespace Pulumi.Gandi.Livedns
{
    public static class GetDomain
    {
        public static Task<GetDomainResult> InvokeAsync(GetDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainResult>("gandi:livedns/getDomain:getDomain", args ?? new GetDomainArgs(), options.WithDefaults());

        public static Output<GetDomainResult> Invoke(GetDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainResult>("gandi:livedns/getDomain:getDomain", args ?? new GetDomainInvokeArgs(), options.WithDefaults());
