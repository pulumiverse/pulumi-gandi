...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("gandi:livedns/domain:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Enable or disable the automatic creation of snapshots when records are changed
func (o DomainOutput) AutomaticSnapshots() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Domain) pulumi.BoolPtrOutput { return v.AutomaticSnapshots }).(pulumi.BoolPtrOutput)
}
