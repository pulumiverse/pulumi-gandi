...
def get_domain(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gandi:domains/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('gandi:domains/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult)
